...
// le texte des boites
  ...
  let stepsData = [
    { "text": "Voici un superbe graphique avec, <mark style='background-color: #4328E7; color:white; padding: 2px; border-radius: 5px;'><strong>sur la courbe bleue</strong></mark>, l'évolution du prix du mazout" },
	...
	// (en gros, le code "observe" ce qu'il est visible à l'écran et change le
	// lien en conséquence)
	// Bref, ça on ne touche pas sinon tout se casse !
